...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gputools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14774&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gputools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gputools` can be installed with:

```
conda install gputools
```

It is possible to list all of the versions of `gputools` available on your platform with:
